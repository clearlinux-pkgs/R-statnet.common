...
Version  : 4.3.0
Release  : 27
URL      : https://cran.r-project.org/src/contrib/statnet.common_4.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/statnet.common_4.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559490042
