...
Version  : 4.7.0
Release  : 49
URL      : https://cran.r-project.org/src/contrib/statnet.common_4.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/statnet.common_4.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662662244
