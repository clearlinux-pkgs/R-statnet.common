...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/statnet.common_4.11.0.tar.gz
...
pushd ..
cp -a statnet.common buildavx2
popd
pushd ..
cp -a statnet.common buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736379055
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/statnet.common/libs/statnet.common.so
/V4/usr/lib64/R/library/statnet.common/libs/statnet.common.so
